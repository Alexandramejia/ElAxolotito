    ...
    <div className="bg-[#f4f4ca] min-h-screen flex flex-col font-sans text-[#5c3c4a]">
      ...
      <main className="flex-grow flex justify-center items-center px-4 py-10">
        <div className="bg-[#fff1e6] p-8 rounded-xl shadow-lg max-w-3xl w-full text-center space-y-6">
          ...
          <p>
            Welcome to <strong>El Axolotito</strong>, where the spirit of Mexico lives in every dish, every color, and every corner.
          ...
          <p>
            We chose the name <strong>El Axolotito</strong> because it's playful, sweet, and proudly Mexican. “Axolotito” is a cute way
          ...
          <p>
            In Aztec mythology, the axolotl is tied to the god <strong>Xolotl</strong>, guardian of the underworld and twin of Quetzalcoatl.
